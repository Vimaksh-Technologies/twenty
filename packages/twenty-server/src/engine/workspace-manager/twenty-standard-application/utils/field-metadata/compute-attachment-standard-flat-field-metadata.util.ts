...
>): Record<AllStandardObjectFieldName<'attachment'>, FlatFieldMetadata> => ({
  ...
  fileId: createStandardFieldFlatMetadata({
    ...
    context: {
      fieldName: 'fileId',
      type: FieldMetadataType.TEXT,
      label: i18nLabel(msg`Internal file Id`),
      description: i18nLabel(msg`Internal stored file identifier`),
      icon: 'IconHash',
      isNullable: true,
      isUIEditable: false,
    },
  ...
  providerAttachmentId: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'providerAttachmentId',
      type: FieldMetadataType.TEXT,
      label: i18nLabel(msg`Provider attachment Id`),
      description: i18nLabel(msg`Attachment identifier from the mail provider`),
      icon: 'IconHash',
      isNullable: true,
      isUIEditable: false,
    },
  ...
  mimeType: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`Declared MIME type of the attachment`),
  ...
  size: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      label: i18nLabel(msg`Size`),
      description: i18nLabel(msg`Attachment size in bytes`),
      icon: 'IconFileInfo',
      isNullable: true,
      isUIEditable: false,
    },
  ...
  safetyState: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'safetyState',
      type: FieldMetadataType.TEXT,
      label: i18nLabel(msg`Safety state`),
      description: i18nLabel(msg`Attachment validation safety state`),
  ...
  quarantineReason: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      ...
      description: i18nLabel(msg`Reason attachment content was quarantined`),
  ...
  message: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`Message containing the attachment`),
      icon: 'IconMail',
      isNullable: true,
      isUIEditable: false,

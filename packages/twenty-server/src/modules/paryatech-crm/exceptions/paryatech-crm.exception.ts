...
export const ParyatechCrmExceptionCode = {
  ...
  COMMERCIAL_CUTOVER_CAS_MISMATCH: 'COMMERCIAL_CUTOVER_CAS_MISMATCH',
...
const FRIENDLY_MESSAGES: Record<ParyatechCrmExceptionCode, MessageDescriptor> =
  {
    ...
    COMMERCIAL_CUTOVER_CAS_MISMATCH: msg`This Agreement changed after cutover inspection. Reconcile the current Twenty record before retrying.`,
